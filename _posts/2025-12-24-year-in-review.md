...
As 2025 comes to a close, I find myself sitting down to reflect on what has been, without a doubt, one of the most transformative years of my professional journey. It’s been a year of building, learning, and most importantly, reconnecting with the reasons why I love this field.
...
* **AWS Certified Solutions Architect - Associate (SAA-C03):** A journey that began at the AWS Summit Madrid and served as a deep dive into the "AWS way of thinking".
* **AWS Certified AI Practitioner:** A natural step as AI moved from the periphery to the center of our daily workflows.
* **Neo4j Certified Professional:** Expanding my graph database expertise to tackle complex data relationships more effectively.
...
* **BilboStack & AWS Summit Madrid:** These events provided the strategic context and the "real tech vibes" needed to stay inspired.
* **TheAntiEvent:** My first Open Space experience, which reminded me that our work is a reflection of our values and ethics. It was a safe space to share the "how" and "why" behind what we build.
...
To the colleagues who challenged me, the community members who shared their knowledge, and everyone who has joined me on this path: thank you for being by my side. This year’s success is shared with all of you.

**Merry Christmas and a Happy New Year!** May your 2026 be full of exciting challenges, clean code, and meaningful connections.
